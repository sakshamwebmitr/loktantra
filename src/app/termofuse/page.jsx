  ...
  return (
    ...
    <div className="w-full h-full flex flex-col items-center justify-evenly">
      ...
      <h3 className="mt-2 text-2xl font-semibold">
        Welcome to लोकतंत्र उद्घोष !
      </h3>
      <p className="w-9/12 mt-5 text-base">
        These terms and conditions outline the rules and regulations for the use
        of Loktantra Udghosh &apos;s Website, located at
        <a
      ...
      <p className="w-9/12 mt-3 text-base">
        ...
        conditions. Do not continue to use लोकतंत्र उद्घोष if you do not agree
      ...
      <p className="w-9/12 mt-3 text-base font-semibold">License</p>
      <p className="w-9/12 mt-3 text-base">
        Most interactive websites use cookies to let us retrieve the user’s
        details for each visit. Cookies are used by our website to enable the
        functionality of certain areas to make it easier for people visiting our
      ...
      <p className="w-9/12 mt-3 text-base font-semibold">You must not:</p>
      <p className="w-9/12 mt-3 text-base">
        Republish material from लोकतंत्र उद्घोष <br />
        Sell, rent or sub-license material from लोकतंत्र उद्घोष <br />
        Reproduce, duplicate or copy material from लोकतंत्र उद्घोष <br />
        Redistribute content from लोकतंत्र उद्घोष
      </p>
      <p className="w-9/12 mt-3 text-base">
      ...
      <p className="w-9/12 mt-3 text-base">
        ...
        Loktantra Udghosh does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Loktantra Udghosh ,its agents and/or affiliates.
        ...
        Loktantra Udghosh shall not be liable for the Comments or for any
      ...
      <p className="w-9/12 mt-3 text-base">
        Loktantra Udghosh reserves the right to monitor all Comments and to
        remove any Comments which can be considered inappropriate, offensive or
        causes breach of these Terms and Conditions.
      </p>
      <p className="w-9/12 mt-3 text-base">You warrant and represent that:</p>
      <p className="w-9/12 mt-3 text-base">
      ...
      <p className="w-9/12 mt-3 text-base">
        You hereby grant Loktantra Udghosh a non-exclusive license to use,
      ...
      <p className="w-9/12 mt-3 text-base">
        ...
        other Website information so long as the link: <br /> (a) is not in any
        way deceptive; <br /> (b) does not falsely imply sponsorship,
        endorsement or approval of the linking party and its products and/or
        services; and <br /> (c) fits within the context of the linking party’s
        site.
      </p>
      <p className="w-9/12 mt-3 text-base">
      ...
      <p className="w-9/12 mt-3 text-base">
        ...
        <br />
        and educational institutions and trade associations. <br />
      </p>
      <p className="w-9/12 mt-3 text-base">
        We will approve link requests from these organizations if we decide
        that: <br /> (a) the link would not make us look unfavorably to
        ...
        Loktantra Udghosh ; and <br /> (d) the link is in the context of general
        resource information.
      </p>
      <p className="w-9/12 mt-3 text-base">
        These organizations may link to our home page so long as the link:{" "}
        <br /> (a) is not in any way deceptive; <br /> (b) does not falsely
        imply sponsorship, endorsement or approval of the linking party and its
        products or services; and <br /> (c) fits within the context of the
        linking party’s site.
      </p>
      <p className="w-9/12 mt-3 text-base">
        If you are one of the organizations listed in paragraph 2 above and are
        interested in linking to our website, you must inform us by sending an
        e-mail to Loktantra Udghosh . Please include your name, your
      ...
      <p className="w-9/12 mt-3 text-base">
        ...
        <br />
        or By use of the uniform resource locator being linked to; <br /> or By
      ...
      <p className="w-9/12 mt-3 text-base">
        No use of Loktantra Udghosh &apos;s logo or other artwork will be allowed for
        linking absent a trademark license agreement.
      </p>
      <p className="w-9/12 mt-3 text-base font-semibold">iFrames</p>
      <p className="w-9/12 mt-3 text-base">
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website.
      </p>
      <p className="w-9/12 mt-3 text-base font-semibold">Content Liability</p>
      <p className="w-9/12 mt-3 text-base">
      ...
      <p className="w-9/12 mt-3 text-base font-semibold">Your Privacy</p>
      <p className="w-9/12 mt-3 text-base font-semibold">
      ...
      <p className="w-9/12 mt-3 text-base font-semibold">Disclaimer</p>
      <p className="w-9/12 mt-3 text-base">
        We do not ensure that the information on this website is correct, we do
        not warrant its completeness or accuracy; nor do we promise to ensure
        that the website remains available or that the material on the website
      ...
      <p className="w-9/12 mt-3 text-base">
        ...
        under applicable law; <br /> or exclude any of our or your liabilities
